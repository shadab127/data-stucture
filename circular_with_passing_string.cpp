...
node* inserting(node* start,string name)
{
    node* temp1 = new(node);
    node* temp2 = new(node);
    ...
    cin>>temp1->percent;
    if( h1.max_marks < temp1->percent )
    {
        h1.max_marks = temp1->percent;
    }
    temp1->next = start;
    if(start == NULL)
    {
...
int main()
{
    ...
    while(1)
    {
        ...
        cout<<"press 5 for display header info"<<endl;
        cin>>choice;
        switch(choice)
        {
        case 1:
        ...
        case 4:
            ...
            break;
        case 5:
            cout<<"maximum percent marks : "<<h1.max_marks<<endl;
            break;
        }
    }
}
